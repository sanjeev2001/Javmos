...
public class CartesianPlane extends java.lang.Object {
    ...
    public void drawPlane(java.awt.Graphics2D graphics2D) {
        ...
        int d = (int) gui.getDomainStep();
        int r = (int) gui.getRangeStep();
        ...
        for (int i = 0; i < 800 / pixel; i++) {
            ...
            graphics2D.drawLine(400 + pixel * i, 395, 400 + pixel * i, 405); //Draws axis tick marks
            graphics2D.drawLine(395, 400 + pixel * i, 405, 400 + pixel * i);//Draws axis tick marks
            graphics2D.drawString(Integer.toString(-i * d), 405 - pixel * i, 399); // Draws negative horizontal axis numbers
            graphics2D.drawString(Integer.toString(i * r), 405, 399 - pixel * i); // Draws positive vertical axis numbers
            graphics2D.drawString(Integer.toString(i * d), 405 + pixel * i, 399); // Draws positive horizontal axis numbers
            graphics2D.drawString(Integer.toString(-i * r), 405, 399 + pixel * i); // Draws negative vertical axis numbers
        } 
    }
}
