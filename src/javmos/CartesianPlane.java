...
public class CartesianPlane extends java.lang.Object {
    ...
    public void drawPlane(java.awt.Graphics2D graphics2D) {
        ...
        for (int i = 0; i < 800 / pixel; i++) {
            ...
            graphics2D.drawString(Integer.toString(i * d), 405, 399 - pixel * i); // Draws positive vertical axis numbers
            graphics2D.drawString(Integer.toString(i * d), 405 + pixel * i, 399); // Draws positive horizontal axis numbers
            graphics2D.drawString(Integer.toString(-i * d), 405, 399 + pixel * i); // Draws negative vertical axis numbers
        } 
    }
}
